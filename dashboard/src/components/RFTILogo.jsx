// RFTILogo.jsx — RF Traffic Intelligence wordmark.
// Sister to DSOATDLogo: same RF— block + cursive middle + hot stamp pattern,
// but with "Traffic" as the product name and "INTEL" as the hot stamp.
//
// Usage:
//   <RFTILogo size={26} showFrame={false} showTagline={false} />

import React from 'react';

export default function RFTILogo({
  ...
  const blockSize = size * 1.2;

  return (
    <div
      className={`rfti-logo ${className}`}
      style={{
        position: 'relative',
        display: 'inline-flex',
        alignItems: 'center',
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: size * 0.25 }}>
          ...
          <div style={{
            position: 'relative',
            // Yellowtail "Traffic" is much wider than "DSO" — bump container width.
            width: fontSize * 3.2,
            height: fontSize * 1.1,
          }}>
            <div style={{
